...
function scene1 () {
  ...
  subtimeline.fromTo(".Track", 0.4, {scaleX: 0, transformOrigin: "left"}, {scaleX: 1, transformOrigin: "left"}, "+=0.2")
...
function scene4 () {
  ...
  subtimeline.fromTo(".Runner-Donut", 0.9, {x: -120, transformOrigin: "left"}, {x: 700, transformOrigin: "left"})
